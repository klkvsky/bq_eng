...
export function ArticleText({
  ...
  const contentWrapper = (
    <div className="font-spectral font-normal text-[17px] xl:text-[18px] leading-5 xl:leading-[24px] -tracking-[0.34px] xl:-tracking-[0.02em]">
      {renderContent()}
    </div>
  );
    ...
    <>
      ...
      {type === "left" && (
        <div className="w-full flex flex-col align-start">
          <div className="font-spectral font-normal text-[17px] xl:text-[28px] leading-5 xl:leading-[32px] -tracking-[0.34px] xl:-tracking-[0.56px] w-full md:w-[calc(6*8.33vw)] xl:w-[calc(9*8.33vw)] -mt-[136px] px-2 xl:px-3">
            {contentWrapper}
          </div>
        </div>
      )}
