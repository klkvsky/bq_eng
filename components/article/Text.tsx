...
export function ArticleText({
  ...
  console.log("ArticleText props:", { text, title, type });
  ...
  return (
    <>
      {type === "center" && (
        <div className="flex flex-col gap-4 max-md:px-2 w-full md:w-[calc(6*8.33vw)] xl:w-[calc(4*8.33vw)] px-2 xl:px-3  2xl:text-[38px] 2xl:leading-[48px] 2xl:-tracking-[0.76px]">
          {title && (
      ...
      {type === "right" && (
        <div className="w-full flex flex-col items-end">
          <div className="font-spectral font-normal text-[17px] xl:text-[28px] leading-5 xl:leading-[32px] -tracking-[0.34px] xl:-tracking-[0.56px] w-full md:w-[calc(6*8.33vw)] xl:w-[calc(9*8.33vw)] -mt-10 xl:-mt-[136px] 2xl:-mt-[90px] px-2 xl:px-3 2xl:text-[42px] 2xl:leading-[58px] 2xl:-tracking-[0.84px]">
            {contentWrapper}
          </div>
        </div>
      )}
