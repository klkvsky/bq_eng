...
export default function ProjectItem(
    ...
    return (
        <>
            {type === "left" ? (
                <div
                    className={cn(props.className, "flex flex-col gap-3")}
                >
                    <div
                        className={cn("relative cursor-pointer", displayMode === "gallery" ? "custom-shadow-right" : "group")}
                        style={{
                            width: displayMode === "gallery" ? mainImageSize[0] : "100%",
                            height: displayMode === "gallery" ? mainImageSize[1] : "320px",
                            maxWidth: displayMode === "gallery" ? mainImageSize[1] : "320px",
                        ...
                        {displayMode === "list" && (
                            <div className="absolute left-0 top-0 w-full h-full bg-white opacity-0 transition-opacity custom-shadow-right-no-margin group-hover:opacity-100 flex flex-col">
                                <p className=" font-apercu font-normal text-[16px] leading-[20px] -tracking-[0.02em] pt-3">
                                    Живой паркинг.<span className="opacity-30">Интерьеры, Москва 2024</span>
                                </p>
                    ...
                    {displayMode === "gallery" && ((
                        <p
                            className="font-apercu font-normal text-[16px] leading-[20px] -tracking-[0.02em] pl-3"
                        >
                            {text}
                        </p>
                    ))}
                ...
                <div className={cn(props.className, "flex flex-row justify-end align-top gap-3")}>
                    {displayMode === "gallery" && ((
                    ...
                    <div className="flex flex-col gap-3">
                        <div
                            className={cn("relative cursor-pointer", displayMode === "gallery" ? "custom-shadow-left" : "group")}
                            style={{
                                width: displayMode === "gallery" ? mainImageSize[0] : "100%",
                                height: displayMode === "gallery" ? mainImageSize[1] : "320px",
                                maxWidth: displayMode === "gallery" ? mainImageSize[1] : "320px",
                        ...
                        {displayMode === "gallery" && ((
                            <p
                                className="font-apercu font-normal text-[16px] leading-[20px] -tracking-[0.02em]"
                            >
                                {text}
                            </p>
                        ))}
