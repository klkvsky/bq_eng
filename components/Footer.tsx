    ...
    <>
      ...
      >
        <a
          ...
          className={cn(
            "whitespace-nowrap w-auto md:w-[16.66vw] hover:opacity-30 transition-opacity duration-500"
          )}
        >
          BQStudio, 2024
        </a>
        <div className="flex flex-col max-md:gap-1 md:flex-row max-md:ml-[12.5vw] w-full md:ml-[calc(1.5*8.33vw)]">
          <a
            className={cn(
          ...
          <a
            className="whitespace-nowrap md:w-[calc(2*8.33vw)] md:ml-[calc(2*8.33vw)] xl:ml-auto xl:text-right hover:opacity-30 transition-opacity duration-500"
      ...
      >
        <a
          className="font-spectral text-[14px] leading-[20px] -tracking-[0.28px] w-[50vw] text-center"
          href="/list"
          onClick={(e) => {
            e.preventDefault();
