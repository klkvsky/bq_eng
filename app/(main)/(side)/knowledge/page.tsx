    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col max-md:items-center md:grid md:grid-cols-2 xl:grid-cols-3 xl:px-[calc(0.5*8.33vw)] xl:gap-x-[calc(8.33vw)] xl:gap-y-0 mt-20 gap-y-0 md:justify-items-center md:min-h-screen">
        {filteredArticles.map((article) => (
          ...
          >
            <div className="xl:aspect-[253/320] relative group xl:hover:custom-shadow-right-articles cursor-pointer max-xl:gap-4 max-xl:flex max-xl:flex-col w-[calc(6*12.5vw)] md:w-[calc(3*8.33vw)] xl:w-[calc(2*8.33vw)] h-auto">
              {article.image && (
                <Image
